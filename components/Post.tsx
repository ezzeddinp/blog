...
export default async function Post({ id, author, date, thumbnail, authorEmail, title, content, links, category }: PostsProps) {
            ...
            <div className='mb-4'>
                {
                    author ? (
                        <>
                            Post by: <span className='font-bold'>{author}</span> on {" "}
                            {formattedDate}
                        </>
                    ) : (
                        <>
